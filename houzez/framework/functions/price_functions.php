...
/*Edited by msn*/
if (!function_exists('msn_houzez_listing__sec_price')) {
    function msn_houzez_listing__sec_price()
    {
        ...
        if (!$price_as_text) {
            $output .= '<span class="item-price item-price-text">' . $second_price . '</span>';
            return $output;
        }
        ...
        if (!empty($second_price)) {
            ...
            return $price_prefix . ' ' . houzez_get_property_price($second_price) . $price_postfix;
        ...
        if (!empty($sale_price)) {
            ...
            if (!empty($sale_price) && !empty($second_price)) {
                ...
                if (is_singular('property')) {
                    /*Edited by msn*/
                    if (!empty($second_price)) {
                        $output .= '<span class="item-price">' . 'ودیعه: ' . $price_prefix . houzez_get_property_price($sale_price) . '</span>';

                    } else {
                        $output .= '<span class="item-price">' . $price_prefix . houzez_get_property_price($sale_price) . '</span>';
                    }
                    if (!empty($second_price)) {
                        $output .= '<span class="item-sub-price">' . 'اجاره: ';
                        $output .= msn_houzez_listing__sec_price($second_price) . $price_postfix;
                        $output .= '</span>';
                    }
                } else {
                    /*Edited by msn*/
                    if (!empty($second_price)) {
                        $output .= $price_prefix . '<span class="item-price">' . 'ودیعه: ' . houzez_get_property_price($sale_price) . '</span>';
                    } else {
