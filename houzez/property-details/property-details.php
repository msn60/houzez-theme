...
$prop_details = false;
/*Edited by msn*/
$msn_second_price = get_post_meta(get_the_ID(), 'fave_property_sec_price', true);
        ...
        <div class="alert alert-info">
            <ul class="list-three-col">
                ...
                if (empty($msn_second_price)) {
                    ...
                    if (!empty($prop_price) && $hide_detail_prop_fields['sale_rent_price'] != 1) {
                        echo '<li><strong>' . esc_html__('قیمت ودیعه:', 'houzez') . '</strong> ' . houzez_listing_price() . '</li>';
                    }
                    echo '<li><strong>' . esc_html__('قیمت اجاره:', 'houzez') . '</strong> ' . msn_houzez_listing__sec_price() . '</li>';
                }
